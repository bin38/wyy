...
async function getMusicInfo(musicItem) {
    ...
    const result = (await axios_1.default.get('http://music.163.com/api/song/detail',
        {
            headers,
            params: data
        })).data;
...
async function getMediaSource(musicItem, quality) {
    try {
        const res = (
            await axios_1.default.get(`https://wyy-api-three.vercel.app/song/url?id=${musicItem.id}&quality=${qualityLevels[quality]}`, {
                timeout: 10000
            })
        ).data;
        ...
        console.log('API返回异常数据:', JSON.stringify(res));
        return null;
    } catch (error) {
...
module.exports = {
    ...
    srcUrl: "https://linux.do/t/topic/717330",
